...
for i=0:9
    ...
    maskedImage(repmat(~BW,[1 1 3])) = 0; %utilizamos la BW obtenida en la app de image segmentation
    figure(i+1)
    ...
    err = immse(input_image_ground_truth, im2uint8(BW)); %encontramos el error
    disp(err)
    %
end
